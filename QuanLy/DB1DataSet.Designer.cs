...
namespace QuanLy {
    ...
    public partial class DB1DataSet : global::System.Data.DataSet {
        ...
        public partial class NhanVienDataTable : global::System.Data.TypedTableBase<NhanVienRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public NhanVienRow AddNhanVienRow(int maNhanVien, string hoTen, string diaChi, string soDT, int maPhongBan) {
...
namespace QuanLy.DB1DataSetTableAdapters {
    ...
    public partial class NhanVienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[NhanVien] WHERE (([maNhanVien] = @Original_maNhanVien) AND ((@IsNull_hoTen = 1 AND [hoTen] IS NULL) OR ([hoTen] = @Original_hoTen)) AND ((@IsNull_diaChi = 1 AND [diaChi] IS NULL) OR ([diaChi] = @Original_diaChi)) AND ((@IsNull_soDT = 1 AND [soDT] IS NULL) OR ([soDT] = @Original_soDT)) AND ((@IsNull_maPhongBan = 1 AND [maPhongBan] IS NULL) OR ([maPhongBan] = @Original_maPhongBan)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[NhanVien] ([maNhanVien], [hoTen], [diaChi], [soDT], [maPhongBa" +
                "n]) VALUES (@maNhanVien, @hoTen, @diaChi, @soDT, @maPhongBan);\r\nSELECT maNhanVie" +
                "n, hoTen, diaChi, soDT, maPhongBan FROM NhanVien WHERE (maNhanVien = @maNhanVien" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NhanVien] SET [maNhanVien] = @maNhanVien, [hoTen] = @hoTen, [diaChi] = @diaChi, [soDT] = @soDT, [maPhongBan] = @maPhongBan WHERE (([maNhanVien] = @Original_maNhanVien) AND ((@IsNull_hoTen = 1 AND [hoTen] IS NULL) OR ([hoTen] = @Original_hoTen)) AND ((@IsNull_diaChi = 1 AND [diaChi] IS NULL) OR ([diaChi] = @Original_diaChi)) AND ((@IsNull_soDT = 1 AND [soDT] IS NULL) OR ([soDT] = @Original_soDT)) AND ((@IsNull_maPhongBan = 1 AND [maPhongBan] IS NULL) OR ([maPhongBan] = @Original_maPhongBan)));
SELECT maNhanVien, hoTen, diaChi, soDT, maPhongBan FROM NhanVien WHERE (maNhanVien = @maNhanVien)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::QuanLy.Properties.Settings.Default.DB1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT maNhanVien, hoTen, diaChi, soDT, maPhongBan FROM dbo.NhanVien";
        ...
        public virtual int Fill(DB1DataSet.NhanVienDataTable dataTable) {
        ...
        public virtual DB1DataSet.NhanVienDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DB1DataSet.NhanVienDataTable dataTable = new DB1DataSet.NhanVienDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DB1DataSet.NhanVienDataTable dataTable) {
        ...
        public virtual int Delete(int Original_maNhanVien, string Original_hoTen, string Original_diaChi, string Original_soDT, global::System.Nullable<int> Original_maPhongBan) {
            ...
            if ((Original_maPhongBan.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[8].Value = ((int)(Original_maPhongBan.Value));
            }
            else {
        ...
        public virtual int Insert(int maNhanVien, string hoTen, string diaChi, string soDT, global::System.Nullable<int> maPhongBan) {
            ...
            if ((maPhongBan.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[4].Value = ((int)(maPhongBan.Value));
            }
            else {
        ...
        public virtual int Update(int maNhanVien, string hoTen, string diaChi, string soDT, global::System.Nullable<int> maPhongBan, int Original_maNhanVien, string Original_hoTen, string Original_diaChi, string Original_soDT, global::System.Nullable<int> Original_maPhongBan) {
            ...
            if ((maPhongBan.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(maPhongBan.Value));
            }
            else {
            ...
            if ((Original_maPhongBan.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(Original_maPhongBan.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string hoTen, string diaChi, string soDT, global::System.Nullable<int> maPhongBan, int Original_maNhanVien, string Original_hoTen, string Original_diaChi, string Original_soDT, global::System.Nullable<int> Original_maPhongBan) {
            return this.Update(Original_maNhanVien, hoTen, diaChi, soDT, maPhongBan, Original_maNhanVien, Original_hoTen, Original_diaChi, Original_soDT, Original_maPhongBan);
        }
    }
